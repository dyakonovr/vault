...
var domainToHttpErrors = common.DomainToHttpErrorMap{
	...
	domain.ErrInvalidAmount:       &common.HttpError{ClientMessage: domain.ErrInvalidAmount.Error(), Code: "WALLET_ACTION_INVALID_AMOUNT", StatusCode: http.StatusBadRequest},
